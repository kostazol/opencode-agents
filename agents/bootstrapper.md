---
mode: subagent
description: Analyzes a request and creates exploration branches with scopes for
  octto brainstorming
temperature: 0.5
permission:
  doom_loop: ask
  external_directory:
    ...
    /home/kostaz/.config/opencode/skill/dotnet-ef-migrations/*: allow
    /home/kostaz/.config/opencode/skill/nuget-manager/*: allow
  question: deny
  plan_enter: deny
  plan_exit: deny
  read:
